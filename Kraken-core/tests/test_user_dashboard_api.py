"""Tests for the user dashboard API."""
...
def test_user_dashboard_api(mock_get_cached) -> None:
    """A user should receive a dashboard via the API."""
    ...
    response = client.get("/users/1/dashboard")
